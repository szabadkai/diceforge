          ...
          <div className="support-content">
            ...
            <div className="support-chapters">
              ...
              <section id="support-die">
                ...
                <p>Generated blade supports place continuous fins beneath the spoke edges that begin at the first printed tip, then join them to low rail feet. Each fin narrows into a 0.18–0.3 mm breakaway interface at the die for cleaner removal. Later perimeter edges are omitted because the solid layers below already carry them. Set the structural width near 0.35 mm for resin or 0.8 mm and above for a multi-line FDM wall.</p>
